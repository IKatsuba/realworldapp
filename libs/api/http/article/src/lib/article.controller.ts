...
export class ArticleController {
  ...
  async deleteComment(@GetUser('id') user: number, @Param() params) {
  ...
  @ApiResponse({ status: 403, description: 'Forbidden.' })
  @Post(':slug/favorite')
  async favorite(@GetUser('id') userId: number, @Param('slug') slug) {
  ...
  async unFavorite(@GetUser('id') userId: number, @Param('slug') slug) {
